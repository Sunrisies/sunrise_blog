...
export class ThirdPartyLibraryController {
  constructor(
    private readonly thirdPartyLibraryService: ThirdPartyLibraryService,
  ) {}
  ...
  @Post()
  async create(
    @Body() createThirdPartyLibraryDto: CreateThirdPartyLibraryDto,
  ...
  async update(
    ...
    return await this.thirdPartyLibraryService.update(
      +id,
      updateThirdPartyLibraryDto,
    );
  }
