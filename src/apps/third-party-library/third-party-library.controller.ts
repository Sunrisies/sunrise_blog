...
export class ThirdPartyLibraryController {
  ...
  @ApiOkResponse({ description: '获取成功', type: ResponseDto<CreateThirdPartyLibraryDto> })
  @ApiBody({
    description: '第三方库信息',
  ...
  @ApiOkResponse({ description: '获取成功', type: PaginatedResponseDto<ThirdPartyLibrary> })
  @ApiQuery({
    name: 'page',
    required: false,
    default: 1,
  ...
  @ApiOkResponse({ description: '修改成功', type: ResponseDto<UpdateThirdPartyLibraryDto> })
  @ApiBody({
    description: '第三方库信息',
    type: UpdateThirdPartyLibraryDto,
  })
  @Put(':id')
  async update(@Param('id') id: string, @Body() updateThirdPartyLibraryDto: UpdateThirdPartyLibraryDto): Promise<ResponseDto<UpdateThirdPartyLibraryDto>> {
